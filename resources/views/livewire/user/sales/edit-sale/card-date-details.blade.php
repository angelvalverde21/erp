<div>
    ...
    <x-user.modal title="Fecha de entrega" id="modal-date-edit-details">

        @livewire('user.sales.edit-sale.modal-date-edit-details', ['order' => $order], key('modal-date-edit-details-' . $order->id))
