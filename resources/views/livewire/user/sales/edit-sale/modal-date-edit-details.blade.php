<div>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col">
            ...
            <x-user.input type="date" wirevalue="order.delivery_date"
        ...
        <div class="col-lg-6 col">
            ...
            <x-user.select wirevalue="order.delivery_time_start" icon="fa-solid fa-clock">
        ...
        <div class="col-lg-6 col">
            ...
            <x-user.select wirevalue="order.delivery_time_end" icon="fa-solid fa-clock">
                <option value="0">Seleccionar</option>
                <option value="8:00:00">8:00 AM</option>
                <option value="9:00:00">9:00 AM</option>
                <option value="10:00:00">10:00 AM</option>
        ...
        <div class="col-lg-12 col">
            <x-user.textarea wirevalue="order.observations_time" id="observations_time">
        ...
        {{-- <div class="col-lg-6 col">
            ...
            <x-user.input-number wirevalue="order.shipping_cost_carrier" label="Costo de envio real" texticon="S/."
            error="Este campo es requerido">
            0.00
        </x-user.input-number>
        ...
        <div class="col-lg-6 col">
            ...
            <x-user.input-number wirevalue="order.shipping_cost_buyer" label="Costo cobrado al cliente" texticon="S/."
            error="Este campo es requerido">
            0.00
        </x-user.input-number>
