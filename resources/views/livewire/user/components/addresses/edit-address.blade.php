            ...
            <div class="mb-3">
                ...
                <div class="resultados">
                    <ul>
                        ...
                        @if (is_array($addressDistricts) || is_object($addressDistricts))
                            @foreach ($addressDistricts as $district)
                                <li><a href="#"
                                        wire:click.prevent="$emit('AddressDistrictAdded','{{ $district->id }}')">{{ $district->name }}
        ...
        <div class="col">
            <div class="float-right" wire:key="delete-address-{{ $address->id }}">
                <button wire:click="deleteAddress({{ $address->id }})" wire:loading.attr="disabled"
                    ...
                    class="btn btn-danger"><i class="fa-solid fa-trash-can"></i> Eliminar</button>
            </div>
        </div>
