<div>
    ...
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModalCenter">
        <i class="fa-solid fa-truck-fast mr-1"></i> Crear Direccion
    </button>
        ...
        <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Crear nueva direccion de envio</h5>
                            ...
                            <div class="mb-3">
                                <div class="input-group mb-1">
                                    ...
                                    <input type="number" class="form-control" id="inputPhone"
                                        wire:model="address.phone" aria-describedby="nameHelp" placeholder="phone">
                                </div>
                                @error('address.phone')
                            ...
                            <div class="mb-3">
                                <div class="input-group mb-1">
                                    ...
                                    <input type="text" class="form-control" id="inputAddressPrimary"
                                        wire:model="address.primary" aria-describedby="nameHelp"
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="mb-3">
                                <input type="text" class="form-control" id="inputAddressSecondary"
                                    wire:model="address.secondary" aria-describedby="nameHelp"
                            ...
                            <div class="mb-3">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="inputReferences"
                                        wire:model="address.references" aria-describedby="nameHelp"
