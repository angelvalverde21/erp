<div>
    ...
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#crearAlbum">
        Crear nuevo album
    </button>

    <x-modal id="crearAlbum" size="modal-lg" title="Crear Album">
        ...
        <form action="#">
            ...
            <div class="form-body">
                ...
                {{-- @livewire('components.locations.create-location', ['reloadUrl' => true], 'location-album') --}}
