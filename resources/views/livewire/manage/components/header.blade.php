<div class="">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        @if (isset($store->nickname))
            ...
            <div class="d-flex justify-content-between align-items-center" style="width: 100%">
                <ul class="navbar-nav ms-1">
                    <li class="nav-item">
                        <a class="nav-link pt-1" data-widget="pushmenu" href="#" role="button" style="font-size: 1.3rem"><i
        ...
        @if ($user->hasRole('admin'))
            ...
            <ul class="navbar-nav ml-auto me-2 mt-1">
                <!-- Navbar Search -->
                <li class="nav-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        @if ($user->stores->count())
                            ...
                            @foreach ($user->stores as $store)
                                <a href="{{ route('manage.profile', [$store->nickname]) }}" class="dropdown-item">
                                    <i class="fa-solid fa-store mr-2"></i> {{ $store->name }}
                                    <span class="float-right text-muted text-sm">10</span>
                                </a>
                                <div class="dropdown-divider"></div>
                            @endforeach
                        @endif
                        ...
                        <a class="dropdown-item" href="#"><i class="fa-solid fa-plus mr-2"></i> Agregar
                            tienda</a>
                    </div>
                </li>
                {{-- <li class="nav-item">
