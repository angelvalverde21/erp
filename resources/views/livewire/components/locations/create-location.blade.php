    ...
    <x-modal title="Buscar o Crear Location" id="agregarLocacion" size="modal-lg">
        ...
        <div class="buscardor-location">
            ...
            <div class="buscador-location d-flex justify-content-between">
                ...
                <button wire:click="new" type="button" class="btn btn-primary d-flex justify-content-between align-items-center"><i class="fa-solid fa-file me-1"></i><span>Nuevo</span> </button>
            </div>
        ...
        @endif
        {{-- <div class="accordion" id="createLocation" wire:ignore.self>
