...
class UploadAlbumController extends Controller
{
    ...
    public function uploadPhotosToAlbum($nickname, $album_id, Request $request)
    {
        try {
            ...
            if (isset($exif)) {
                ...
                if (isset($exif['IFD0']['Orientation'])) {
                    ...
                    if ($exif['IFD0']['Orientation']>1) {
                    //se debe rotar la imagen
                    Log::info('La imagen esta rotada');
