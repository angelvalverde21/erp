...
namespace App\Http\Livewire\User\Product\Categories;
...
class CreateCategory extends Component
{
    ...
    public function save()
    {
        ...
        $this->emitTo('user.product.create-product', 'render');
    ...
    public function render()
    {
        ...
        return view('livewire.user.product.categories.create-category', compact('categoriesRecursive'));
    }
}
