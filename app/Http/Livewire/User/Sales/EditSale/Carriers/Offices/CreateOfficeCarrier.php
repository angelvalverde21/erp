...
namespace App\Http\Livewire\User\Sales\EditSale\Carriers\Offices;
...
class CreateOfficeCarrier extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.user.sales.edit-sale.carriers.offices.create-office-carrier',compact('districts'));
    }
}
