...
namespace App\Http\Livewire\User\Sales\EditSale\Items;
...
class CardShowAllItems extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.user.sales.edit-sale.items.card-show-all-items', compact('items'));
    }
}
